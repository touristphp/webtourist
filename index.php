...
<head>
    ...
    <link rel="stylesheet" href="view/assets/bootstrap/css/mdb.min.css">
    ...
    <!--ytp player-->
    <link rel="stylesheet" href="view/assets/css/YTPlayer.css">  
    <!--- owl carousel Css-->
    <link rel="stylesheet" href="view/assets/owlcarousel/css/owl.carousel.css">
    <link rel="stylesheet" href="view/assets/owlcarousel/css/owl.theme.css"> 
    <!--Flex slider-->
    <link rel="stylesheet" href="view/assets/css/flexslider.css">    
    <!-- component CSS -->  
    <link rel="stylesheet" href="view/assets/css/aos.css">           
    <!-- Style CSS -->
    <link rel="stylesheet" href="view/assets/css/style.css">     
    <link rel="stylesheet" href="view/assets/css/quy.css">   
    <link rel="stylesheet" href="view/assets/css/review.css">  
     <!-- start link by Thanh -->
  ...
  <body data-spy="scroll" data-offset="80">
    ...
    <!-- START NAVBAR -->
          <!-- <nav class="navbar navbar-toggleable-sm fixed-top navbar-light bg-faded site-navigation">
            <div class="container">
                <a class="navbar-brand" href="index.html"><img src="view/assets/img/logo.png" alt=""></a> -->          
        ...
        <nav class="navbar navbar-expand-lg fixed-top navbar-light bg-faded site-navigation">
            <div class="container">
                <a class="navbar-brand" href="view/index.php"><img src="view/assets/img/logo.png" alt=""></a>
                ...
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    <div class="navbar-nav">
                        ...
                        <a class="nav-item nav-link" href="view/login.php">Login</a></li>
                    </div>
                </div>
            </div>
        </nav>
...
<!-- START HOME -->
<section id="home" class="home_parallax" style="background-image: url(view/assets/img/bg/youtube-bg.jpg);  background-size:cover; background-position: center center;">			
...
<!-- START WHY CHOOSE US -->	
<section data-stellar-background-ratio="0.3" class="why_choose section-padding"  style="background-image: url(view/assets/img/bg/service-bg.jpg);  background-size:cover; background-position: center center;">			
	<div class="container">
		<div class="row">
			...
			<div class="col-md-12" data-aos="fade-up">
				<div id="package-slider" class="owl-carousel">
					<div class="single_package"> 
						<img class="img-fluid" src="view/assets/img/package/1.jpg" alt="">
					...
					<div class="single_package"> 
						<img class="img-fluid" src="view/assets/img/package/2.jpg" alt="">
					...
					<div class="single_package"> 
						<img class="img-fluid" src="view/assets/img/package/3.jpg" alt="">
					...
					<div class="single_package"> 
						<img class="img-fluid" src="view/assets/img/package/4.jpg" alt="">
					...
					<div class="single_package"> 
						<img class="img-fluid" src="view/assets/img/package/5.jpg" alt="">
					...
					<div class="single_package"> 
						<img class="img-fluid" src="view/assets/img/package/6.jpg" alt="">
			...
			<div class="col-md-12" data-aos="fade-up">
				<div id="gallery-slider" class="owl-carousel">
					<div class="single_gallery">
						<img src="view/assets/img/gallery/1.jpg" class="img-gallery" alt="" />
					...
					<div class="single_gallery">
						<img src="view/assets/img/gallery/2.jpg" class="img-gallery" alt="" />
						<div class="gallery_info">
							<h1>flights</h1>
							<p>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat.</p>
						</div>
					...
					<div class="single_gallery">
						<img src="view/assets/img/gallery/3.jpg" class="img-gallery" alt="" />
						<div class="gallery_info">
							<h1>cruises</h1>
							<p>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat.</p>
						</div>
					...
					<div class="single_gallery">
						<img src="view/assets/img/gallery/4.jpg" class="img-gallery" alt="" />
						<div class="gallery_info">
							<h1>hotels</h1>
							<p>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat.</p>
						</div>
			...
			<div class="col-lg-6" data-aos="fade-up">
				<div class="single_blog">
					<div class="blog-text wow fadeInLeft">
						<h4><a href="view/review.php">Blog title here</a></h4>
						Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat.
						<p><strong> 25 August, 2017</strong></p>
					</div>
					<img class="blog-photo" width="420" height="350" alt="" src="view/assets/img/blog/blog1.jpg"/>
				</div>
			</div><!--- END COL -->
			<div class="col-lg-6" data-aos="fade-up">
				<div class="single_blog">
					...
					<img class="blog-photo" width="420" height="350" alt="" src="view/assets/img/blog/blog2.jpg"/>
				</div>
			</div><!--- END COL -->
			<div class="col-lg-6" data-aos="fade-up">
				<div class="single_blog">
					...
					<img class="blog-photo" width="420" height="350" alt="" src="view/assets/img/blog/blog3.jpg"/>
				</div>
			</div><!--- END COL -->
			<div class="col-lg-6" data-aos="fade-up">
				<div class="single_blog">
					...
					<img class="blog-photo" width="420" height="350" alt="" src="view/assets/img/blog/blog4.jpg"/>
				</div>
			</div><!--- END COL -->
		</div><!--- END ROW -->
	</div><!--- END CONTAINER -->
...
<div data-stellar-background-ratio="0.3" class="partner-logo" style="background-image: url(view/assets/img/bg/partner-bg.jpg);  background-size:cover; background-position: center center;">
	<div class="container">
		<div class="row">
			<div class="col-md-12" data-aos="fade-up">
				<div class="partner">
					<a href="#"><img src="view/assets/img/partner/1.jpg" alt="image"></a>
					<a href="#"><img src="view/assets/img/partner/2.jpg" alt="image"></a>
					<a href="#"><img src="view/assets/img/partner/3.jpg" alt="image"></a>
					<a href="#"><img src="view/assets/img/partner/4.jpg" alt="image"></a>
					<a href="#"><img src="view/assets/img/partner/5.jpg" alt="image"></a>
					<a href="#"><img src="view/assets/img/partner/6.jpg" alt="image"></a>
					<a href="#"><img src="view/assets/img/partner/1.jpg" alt="image"></a>
					<a href="#"><img src="view/assets/img/partner/2.jpg" alt="image"></a>
					<a href="#"><img src="view/assets/img/partner/3.jpg" alt="image"></a>
					<a href="#"><img src="view/assets/img/partner/4.jpg" alt="image"></a>
...
<!-- modernizer JS -->      
<script src="view/assets/js/modernizr.2.5.3.min.js"></script>                                                                    
<!-- owl-carousel min js  -->
<script src="view/assets/owlcarousel/js/owl.carousel.min.js"></script>
<!-- stellar js -->
<script src="view/assets/js/jquery.stellar.min.js"></script>
<!-- countTo js -->
<script src="view/assets/js/jquery.inview.min.js"></script>  
<!-- video scripts -->
<script src="view/assets/js/jquery.mb.YTPlayer.min.js"></script>	
<script type="text/javascript">
	$('.player').mb_YTPlayer();
</script>
<!-- jquery flexslider min js -->
<script src="view/assets/js/jquery.flexisel.js"></script>
<script src="view/assets/js/jquery.flexslider-min.js"></script>              
<!-- scrolltopcontrol js -->
<script src="view/assets/js/scrolltopcontrol.js"></script>                                   
<!-- form-contact js -->
<script src="view/assets/js/form-contact.js"></script>   
<!-- aos js -->
