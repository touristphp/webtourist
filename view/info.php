...
<section id="special_package" class="special_package section-padding">
	<div class="container">
		...
		<div class="row" data-aos="fade-up">
			<div class="col-md-2">
				<div class="avatar">
					<img src="assets/img/avatar_user/ha.jpg" class="thumb">
				</div>
			</div>
			<div class="col-md-10">
				<div class="row header-comment"><h3>Quang Tuan</h3></div>
	...
	<div class="container">
		<div class="row" data-aos="fade-up">
			<div class="col-md-2">
				<div class="avatar">
					<img src="assets/img/avatar_user/trang.jpg" class="thumb">
				</div>
			</div>
			<div class="col-md-10">
				<div class="row header-comment"><h3>Nguyen Thanh</h3></div>
				<div class="row post-comment"> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptas sapiente beatae architecto sit praesentium deleniti illum facere velit. Nemo, ipsum! Iste accusantium maiores aliquam in perspiciatis nihil quod necessitatibus at.</div>
				<div class="row like-comment">
					<button type="button" class="btn btn-outline-primary btn-sm">
          				<span><i class="material-icons">thumb_up</i> 77 Like </span> Like</button>
	...
	<div class="container">
		<div class="row" data-aos="fade-up">
			<div class="col-md-2">
				<div class="avatar">
					<img src="assets/img/avatar_user/ngoc.jpg" class="thumb">
				</div>
			</div>
			<div class="col-md-10">
				<div class="row header-comment"><h3>Ngoc Quy</h3></div>
				<div class="row post-comment"> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptas sapiente beatae architecto sit praesentium deleniti illum facere velit. Nemo, ipsum! Iste accusantium maiores aliquam in perspiciatis nihil quod necessitatibus at.</div>
				<div class="row like-comment">
					<button type="button" class="btn btn-outline-primary btn-sm">
          				<span><i class="material-icons">thumb_up</i> 77 Like </span> Like</button>
	...
	<div class="container">
		<div class="row" data-aos="fade-up">
			<div class="col-md-2">
				<div class="avatar">
					<img src="assets/img/avatar_user/nhi.jpg" class="thumb">
				</div>
			</div>
			<div class="col-md-10">
				<div class="row header-comment"><h3>Diana</h3></div>
				<div class="row post-comment">

					<textarea id="textarea" class="style-scope iron-autogrow-textarea" rows="1" autocomplete="off" placeholder="Add a comment of you..." maxlength="10000"></textarea>
				</div>
				<div class="row like-comment">
